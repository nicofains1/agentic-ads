 ...
 *
 * Setup:
 *   1. Register at https://agentic-ads-production.up.railway.app/api/register (POST with {name, email})
 *      → Returns your developer API key (aa_dev_...)
 *   2. Set AGENTIC_ADS_API_KEY env var to your key
 *   3. npm run build && node build/index.js
 */

const AGENTIC_ADS_SERVER = "https://agentic-ads-production.up.railway.app";
...
async function main() {
  if (!DEVELOPER_API_KEY) {
    console.error(
      ...
      "[weather-with-ads] Register at: POST https://agentic-ads-production.up.railway.app/api/register\n" +
